...
export const ContextProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        const predict = () => {
            ...
            const input = tf.tensor2d([[2016, 59.60018333, 0.755792502, 25.75660833]]);
    ...
    return (
        <StateContext.Provider value={{ countriesData, countryId, setCountryId, location, setLocation, setNewData }}>
            {children}
