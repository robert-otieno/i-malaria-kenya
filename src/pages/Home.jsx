    ...
    <>
      <div className='h-screen md:overflow-hidden overflow-auto md:hover:overflow-auto p-4 max-w-6xl mx-auto scrollbar-hide'>
        <div className='flex items-center space-x-2 text-slate-600 mb-2'>
          ...
          {/* <select onChange={(e) => { setFilterParam(e.target.value) }} className="flex-1 rounded-md ring-1 ring-slate-200 bg-white py-2 px-3 shadow-sm focus:outline-none focus:ring-teal-500 sm:text-sm" aria-label="Filter Countries By Region">
